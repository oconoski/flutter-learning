...
class ActionButtonCustom extends StatefulWidget {
  ActionButtonCustom({super.key});

  @override
  State<ActionButtonCustom> createState() => _ActionButtonCustomState();
}

class _ActionButtonCustomState extends State<ActionButtonCustom> {
  bool morePressed = true;
  @override
  Widget build(BuildContext context) {
    return ExpansibleMenu(
      distance: 100,
      children: [
        ActionButton(
...
@immutable
class ExpansibleMenu extends StatefulWidget {
  const ExpansibleMenu({
    super.key,
    this.initialOpen,
